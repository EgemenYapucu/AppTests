...
// Telefon numarası 0 (5xx) ile başlamalıdır.
	public static void main(String[] args){
		...
		driver.findElement(By.name("Şifre")).sendKeys("123456EeA");
		driver.findElement(By.name("Telefon Numarası")).sendKeys("08467891245");
		...
		if(expected_title.equals(actual_title)){
			...
			System.out.println("Case 14 successful");
